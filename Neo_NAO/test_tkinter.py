...
canvas = Canvas(frame_canvas, width = sizeX, height = sizeY, background = 'gray')

# ajout d'une image du Nao
#tetenao = PhotoImage(file='tetenao.gif')
#image = Image.open("tetenao.jpg")
#tetenao = ImageTk.PhotoImage(image)
tetenao = PhotoImage(file ="/home/chaikou/Documents/Neo_NAO/toto.png") # attention si ya une instance Tkinter encore ouverte ça chie
x = sizeX / 2
y = sizeY / 2
