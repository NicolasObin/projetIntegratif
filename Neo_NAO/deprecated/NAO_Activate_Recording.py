...
if __name__ == "__main__":
	...
	parser.add_option("-o","--odir",dest = "odir", help = "Path to the output directory")

	parser.set_defaults(filename = '/home/nao/recordings/audio_acquisition.wav',duration = 15)
	...
	# Beat-tracker
	[out_beat,first] = runBeatTracking(out_impro) # base sur l'audio 
	...
	#NaoMouvement(1,15,robotIP,PORT,False)
	#time.sleep(first-0.2)
	NaoMouvement(out_beat,20,robotIP,PORT,False)
