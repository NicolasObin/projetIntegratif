...
#fs, can1L = wav.read('wavs/gauche_debruiteCan1.wav','r')
#fs, can2R = wav.read('wavs/gauche_debruiteCan2.wav','r')
#fs, can1L = wav.read('wavs/droite_debruiteCan1.wav','r')
#fs, can2R = wav.read('wavs/droite_debruiteCan2.wav','r')
#fs, can1L = wav.read('wavs/face_debruiteCan1.wav','r')
#fs, can2R = wav.read('wavs/face_debruiteCan2.wav','r')
...
if topmax1L > topmax2R:
	print 'ILD : le son vient sûrement de gauche'
else:
	print 'ILD : le son vient sûrement de droite'
